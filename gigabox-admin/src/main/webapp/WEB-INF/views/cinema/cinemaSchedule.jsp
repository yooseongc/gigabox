...
<!-- Datetimepicker -->
<link rel="stylesheet" href="/admin/resources/datetimepicker/css/bootstrap-datetimepicker.min.css" />
<script type="text/javascript" src="/admin/resources/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/admin/resources/datetimepicker/js/locales/bootstrap-datetimepicker.ko.js"></script>

...
<!-- jquery-seat-chart -->
<link rel="stylesheet" type="text/css" href="/admin/resources/jquery-seat-chart/jquery.seat-charts.css">
<script src="/admin/resources/jquery-seat-chart/jquery.seat-charts.js"></script> 

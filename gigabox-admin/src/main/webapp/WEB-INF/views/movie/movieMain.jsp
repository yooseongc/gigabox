...
<!-- Bootstrap Core CSS -->
<link href="/admin/resources/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">

<!-- MetisMenu CSS -->
<link href="/admin/resources/vendor/metisMenu/metisMenu.min.css"
	rel="stylesheet">
...
<!-- Custom Fonts -->
<link href="/admin/resources/vendor/font-awesome/css/font-awesome.min.css"
...
<script src="/admin/resources/vendor/bootstrap/js/bootstrap.min.js"></script>

<!-- Metis Menu Plugin JavaScript -->
<script src="/admin/resources/vendor/metisMenu/metisMenu.min.js"></script>

<!-- Custom Theme JavaScript -->
<script src="/admin/resources/dist/js/sb-admin-2.js"></script>
...
<!-- KOBIS API -->
<script type="text/javascript" src="/admin/resources/kobis/KobisOpenAPIRestService.js"></script>

<!-- summernote -->
<link href="/admin/resources/summernote/summernote.css" rel="stylesheet"/>
<script type="text/javascript" src="/admin/resources/summernote/summernote.min.js"></script>
<script type="text/javascript" src="/admin/resources/summernote/lang/summernote-ko-KR.js"></script>

<!-- jQuery-File-Upload-Plugin with Bootstrap -->
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="/admin/resources/jQuery-File-Upload-master/css/jquery.fileupload.css">
			...
			$("#movieInsertSearchListTable").on("click", "#movieInsertSearchListTableBody tr", function(e) {
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#movieSteelcut").val("http://choiys3574.cafe24.com/upload/gigabox/movie/steelcut/" + $("#movieCode").val());
						$("#movieTrailer").val("http://choiys3574.cafe24.com/upload/gigabox/movie/trailer/" + $("#movieCode").val());

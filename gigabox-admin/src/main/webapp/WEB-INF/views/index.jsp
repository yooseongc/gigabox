...
<!-- Morris Charts CSS -->
<link href="/admin/resources/vendor/morrisjs/morris.css" rel="stylesheet">
...
<!-- Calendar -->
<script type="text/javascript" src='/admin/resources/calendar/js/sweetalert.min.js?ver=1'></script>
<link rel="stylesheet" type="text/css" href='/admin/resources/css/sweetalert.css?ver=1.2'>
<script type="text/javascript" src="/admin/resources/calendar/js/stringBuffer.js"></script>
<script type="text/javascript" src="/admin/resources/calendar/js/calendar.js"></script>
<script type="text/javascript" src="/admin/resources/calendar/js/calendarSchdule.js"></script>

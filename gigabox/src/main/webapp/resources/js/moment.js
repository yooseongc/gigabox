...
(function (undefined) {
    ...
    var moment,
        ...
        parseTokenWord = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, // any
																																				...
																																				// in
																																				// arabic.
        parseTokenTimezone = /Z|[\+\-]\d\d:?\d\d/i, // +00:00 -00:00 +0000 -0000
													// or Z
    ...
    extend(Language.prototype, {
        ...
        _week : {
            ...
            doy : 6  // The week that contains Jan 1st is the first week of
						// the year.
        },
    ...
    function dateFromConfig(config) {
        ...
        if (config._w && config._a[DATE] == null && config._a[MONTH] == null) {
            ...
            if (w.GG != null || w.W != null || w.E != null) {
                ...
                // if we're parsing 'd', then the low day numbers may be next
				// week
        ...
        diff : function (input, units, asFloat) {
            ...
            if (units === 'year' || units === 'month') {
                ...
                output = units === 'second' ? diff / 1e3 : // 1000
                    ...
                    units === 'day' ? (diff - zoneDiff) / 864e5 : // 1000 * 60
																	// * 60 *
																	// 24,
																	// negate
																	// dst
    ...
    // add shortcut for year (uses different syntax than the getter/setter
	// 'year' == 'FullYear')

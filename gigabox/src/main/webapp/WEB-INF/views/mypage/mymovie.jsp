			...
			<div class="row">
				...
				<div class="board-inner">
					<ul class="nav nav-tabs" id="myTab">
							<!-- 마일리지 정보 -->
						<li><a href="/mypage/mileageInfo" data-toggle="tab" title="마일리지 정보">
						...
						<!-- 마이무비 -->
						<li class="active"><a href="/mypage/mymovie" data-toggle="tab" title="마이무비">
					...
					<div class="tab-pane fade in active" id="settings">
						<div class="row">
							<c:forEach items="${bookmarkList}" var="bookmarkItem">
								<div class="col-md-3 col-sm-6" data-role="bookmarkItem">
									<div class="panel panel-default text-center">
										...
										<div class="panel-body">
											<div>
												...
												<div class="rating">
													<input id="starRating" value="${bookmarkItem.movie.reviewStarscore}"

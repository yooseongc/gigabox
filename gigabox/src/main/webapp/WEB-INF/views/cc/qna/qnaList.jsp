		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li><a href="/inquiry/inquiryList" class="inquiry"
						title="1:1문의 바로가기">1:1문의</a></li>
				</ul>
			</div>
		</div>
		<!-- /.row -->
					...
					<div class="text-center">
						<ul class="pagination">
							<c:if test="${pageMaker.prev}">
								<li><a
									href="/inquiry/inquiryList${pageMaker.makeQuery(pageMaker.startPage-1)}">&laquo;</a></li>
							</c:if>
							...
							<c:forEach begin="${pageMaker.startPage}"
								...
								<li
									...
									<a href="/inquiry/inquiryList${pageMaker.makeQuery(idx)}">${idx}</a>
								</li>
							</c:forEach>

							<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
								<li><a
									href="/inquiry/inquiryList${pageMaker.makeQuery(pageMaker.endPage+1)}">&raquo;</a></li>
							</c:if>
						</ul>
					</div>
					<!-- Footer -->
